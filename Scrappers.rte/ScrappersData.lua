...
--
ScrappersData.Ammunition[name].FireSound = {}
ScrappersData.Ammunition[name].FireSound["Add"] = "Fire Add 50AE"
ScrappersData.Ammunition[name].FireSound["AddVariants"] = 1
...
ScrappersData.Ammunition[name] = {}
--
ScrappersData.Ammunition[name].ProjectilePresetName = "Particle Bullet 950JDJ"
ScrappersData.Ammunition[name].ProjectileCount = 9
ScrappersData.Ammunition[name].ProjectileSpread = 0
ScrappersData.Ammunition[name].ProjectileVelocity = 110
--
ScrappersData.Ammunition[name].CasingPresetName = "Casing 950JDJ"
--
ScrappersData.Ammunition[name].SmokeAmount = 60
--
--
ScrappersData.Ammunition[name].FireSound = {}
ScrappersData.Ammunition[name].FireSound["Add"] = ""
ScrappersData.Ammunition[name].FireSound["AddVariants"] = 0
ScrappersData.Ammunition[name].FireSound["AddSemi"] = "Fire Add Semi 950JDJ"
ScrappersData.Ammunition[name].FireSound["AddSemiVariants"] = 1
--
ScrappersData.Ammunition[name].FireSound["Bass"] = ""
ScrappersData.Ammunition[name].FireSound["BassSemi"] = "Fire Bass Semi 950JDJ"
--
--
ScrappersData.Ammunition[name].FireSuppressedSound = {}
ScrappersData.Ammunition[name].FireSuppressedSound["Add"] = ""
...
--
--
ScrappersData.Ammunition[name].BaseNoiseVolume = 1.05
ScrappersData.Ammunition[name].BaseNoisePitch = 0.9
--
ScrappersData.Ammunition[name].BaseNoiseSemiVolume = 1.15
ScrappersData.Ammunition[name].BaseNoiseSemiPitch = 0.7
--
...
ScrappersData.Ammunition[name].FireSound["AddVariants"] = 8
ScrappersData.Ammunition[name].FireSound["AddSemi"] = ""
ScrappersData.Ammunition[name].FireSound["AddSemiVariants"] = 0
--
...
ScrappersData.Ammunition[name] = {}
--
ScrappersData.Ammunition[name].ProjectilePresetName = "Particle Bullet 20Ga"
ScrappersData.Ammunition[name].ProjectileCount = 5
ScrappersData.Ammunition[name].ProjectileSpread = 5
ScrappersData.Ammunition[name].ProjectileVelocity = 85
--
ScrappersData.Ammunition[name].CasingPresetName = "Casing 20Ga"
--
ScrappersData.Ammunition[name].SmokeAmount = 10
--
--
ScrappersData.Ammunition[name].FireSound = {}
ScrappersData.Ammunition[name].FireSound["Add"] = "Fire Add 20Ga"
ScrappersData.Ammunition[name].FireSound["AddVariants"] = 2
ScrappersData.Ammunition[name].FireSound["AddSemi"] = "Fire Add Semi 20Ga"
ScrappersData.Ammunition[name].FireSound["AddSemiVariants"] = 1
--
ScrappersData.Ammunition[name].FireSound["Bass"] = "Fire Bass 20Ga"
ScrappersData.Ammunition[name].FireSound["BassSemi"] = "Fire Bass Semi 20Ga"
--
--
ScrappersData.Ammunition[name].FireSuppressedSound = {}
ScrappersData.Ammunition[name].FireSuppressedSound["Add"] = "Fire Add MediumShotgun Suppressed"
ScrappersData.Ammunition[name].FireSuppressedSound["AddVariants"] = 1
ScrappersData.Ammunition[name].FireSuppressedSound["AddSemi"] = "Fire Add Semi MediumShotgun Suppressed"
ScrappersData.Ammunition[name].FireSuppressedSound["AddSemiVariants"] = 1
--
ScrappersData.Ammunition[name].FireSuppressedSound["Bass"] = "Fire Bass Semi 20Ga A" -- weird, works tho
ScrappersData.Ammunition[name].FireSuppressedSound["BassVariants"] = 1
--
ScrappersData.Ammunition[name].NoiseSound = defaultNoise
--
...
--
ScrappersData.Ammunition[name].BaseNoiseSemiVolume = 0.85
ScrappersData.Ammunition[name].BaseNoiseSemiPitch = 1.16
--
ScrappersData.Ammunition[name].BaseBassVolume = 1
ScrappersData.Ammunition[name].BaseBassPitch = 1
...
ScrappersData.Ammunition[name] = {}
--
ScrappersData.Ammunition[name].ProjectilePresetName = "Particle Bullet 12Ga"
ScrappersData.Ammunition[name].ProjectileCount = 7
ScrappersData.Ammunition[name].ProjectileSpread = 5
ScrappersData.Ammunition[name].ProjectileVelocity = 95
--
ScrappersData.Ammunition[name].CasingPresetName = "Casing 12Ga"
--
ScrappersData.Ammunition[name].SmokeAmount = 13
--
--
ScrappersData.Ammunition[name].FireSound = {}
ScrappersData.Ammunition[name].FireSound["Add"] = "Fire Add 12Ga"
ScrappersData.Ammunition[name].FireSound["AddVariants"] = 1
ScrappersData.Ammunition[name].FireSound["AddSemi"] = "Fire Add Semi 12Ga"
ScrappersData.Ammunition[name].FireSound["AddSemiVariants"] = 2
--
ScrappersData.Ammunition[name].FireSound["Bass"] = "Fire Bass 12Ga"
ScrappersData.Ammunition[name].FireSound["BassSemi"] = "Fire Bass Semi 12Ga"
--
--
ScrappersData.Ammunition[name].FireSuppressedSound = {}
ScrappersData.Ammunition[name].FireSuppressedSound["Add"] = "Fire Add MediumShotgun Suppressed"
...
ScrappersData.Ammunition[name].BaseNoisePitch = 0.95
--
ScrappersData.Ammunition[name].BaseNoiseSemiVolume = 0.95
ScrappersData.Ammunition[name].BaseNoiseSemiPitch = 1.05
--
ScrappersData.Ammunition[name].BaseBassVolume = 1
ScrappersData.Ammunition[name].BaseBassPitch = 1
...
name = "Reload Magazine Very Small Rifle F"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutPrepareDelay = 700
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutAfterDelay = 250

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInPrepareDelay = 1100
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInAfterDelay = 400

ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Very Small Rifle F MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 140

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Very Small Rifle F MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 420 -- dude weed

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Very Small Rifle F MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 470

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Very Small Rifle F MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 270
...
name = "Reload Magazine Small Rifle E"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutPrepareDelay = 400
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutAfterDelay = 600

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInPrepareDelay = 600
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInAfterDelay = 350

ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Small Rifle E MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 200

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Small Rifle E MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 200

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Small Rifle E MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 145

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Small Rifle E MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 145

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound"}

name = "Reload Magazine Small Rifle F"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Small Rifle F MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 100

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Small Rifle F MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 200

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Small Rifle F MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 155

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Small Rifle F MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 190
...
name = "Reload Magazine Medium Rifle G"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Medium Rifle G MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 95

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Medium Rifle G MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 150

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Medium Rifle G MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 170

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Medium Rifle G MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 115

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound"}

name = "Reload Magazine Medium Rifle H"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Medium Rifle H MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 90

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Medium Rifle H MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 125

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Medium Rifle H MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 210

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Medium Rifle H MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 170
...
name = "Reload Magazine Large Rifle H"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInPrepareDelay = 1000
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInAfterDelay = 205

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagHitPrepareDelay = 210
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagHitAfterDelay = 500

ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle H MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 115

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle H MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 275

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle H MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 170

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle H MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 130
...
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["SoundContainer"] = "Reload Magazine Large Rifle H MagHit"
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["Length"] = 190

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound", "MagHitPrepareSound", "MagHitSound"}

name = "Reload Magazine Large Rifle I"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle I MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 60

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle I MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle I MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 210

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle I MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 280

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound"}

name = "Reload Magazine Large Rifle J"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle J MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 400

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle J MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 200

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle J MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 210

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle J MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 345

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound"}

name = "Reload Magazine Large Rifle K"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutPrepareDelay = 850
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutAfterDelay = 1100

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInPrepareDelay = 1000
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInAfterDelay = 500

ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle K MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 180

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle K MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 240

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle K MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 530

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle K MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 290

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound"}

name = "Reload Magazine Large Rifle L"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle L MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 180

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle L MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle L MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 170

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle L MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 130
...
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["SoundContainer"] = "Reload Magazine Large Rifle L MagHit"
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["Length"] = 140

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound", "MagHitPrepareSound", "MagHitSound"}

name = "Reload Magazine Large Rifle M"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle M MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 105

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle M MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 250

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle M MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 200

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle M MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 200

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound"}

name = "Reload Magazine Large Rifle N"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutPrepareDelay = 850
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutAfterDelay = 1000

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInPrepareDelay = 1000
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInAfterDelay = 300

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagHitPrepareDelay = 280
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagHitAfterDelay = 500

ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle N MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 100

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle N MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle N MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 170

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle N MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 160
...
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["SoundContainer"] = "Reload Magazine Large Rifle N MagHit"
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["Length"] = 140

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound", "MagHitPrepareSound", "MagHitSound"}

name = "Reload Magazine Large Rifle O"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle O MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 240

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle O MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle O MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 490

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle O MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 120

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound"}

name = "Reload Magazine Large Rifle P"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle P MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 80

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle P MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 220

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle P MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 275

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle P MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 150
...
name = "Reload Magazine Large Rifle R"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle R MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 380

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Large Rifle R MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 170

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Large Rifle R MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 365

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Large Rifle R MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInPrepareDelay = 1400
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInAfterDelay = 150

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagHitPrepareDelay = 150
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagHitAfterDelay = 600

ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Very Large Rifle A MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 450

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Very Large Rifle A MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 410

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Very Large Rifle A MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 190

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Very Large Rifle A MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 230
...
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["SoundContainer"] = "Reload Magazine Very Large Rifle A MagHit"
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["Length"] = 280

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound", "MagHitPrepareSound", "MagHitSound"}

name = "Reload Magazine Very Large Rifle B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Very Large Rifle B MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 400

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Very Large Rifle B MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 400

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Very Large Rifle B MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 220

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Very Large Rifle B MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["SoundContainer"] = "Reload Magazine Very Large Rifle B MagHit"
ScrappersData.ReloadSoundSets.Magazine[name].MagHitSound["Length"] = 250

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"MagOutPrepareSound", "MagOutSound", "MagInPrepareSound", "MagInSound", "MagHitPrepareSound", "MagHitSound"}

name = "Reload Magazine Very Large Rifle C"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutPrepareDelay = 700
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagOutAfterDelay = 800

ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInPrepareDelay = 1500
ScrappersData.ReloadSoundSets.Magazine[name].BaseMagInAfterDelay = 700

ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["SoundContainer"] = "Reload Magazine Very Large Rifle C MagOutPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutPrepareSound["Length"] = 425

ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["SoundContainer"] = "Reload Magazine Very Large Rifle C MagOut"
ScrappersData.ReloadSoundSets.Magazine[name].MagOutSound["Length"] = 270

ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["SoundContainer"] = "Reload Magazine Very Large Rifle C MagInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].MagInPrepareSound["Length"] = 500

ScrappersData.ReloadSoundSets.Magazine[name].MagInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["SoundContainer"] = "Reload Magazine Very Large Rifle C MagIn"
ScrappersData.ReloadSoundSets.Magazine[name].MagInSound["Length"] = 330
...
name = "Reload RoundLoad Medium Rifle Single Round A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInPrepareDelay = 180
ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInAfterDelay = 310

ScrappersData.ReloadSoundSets.Magazine[name].RoundInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInPrepareSound["SoundContainer"] = "Reload RoundLoad Medium Rifle A RoundInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInPrepareSound["Length"] = 180

ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Medium Rifle A RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 400

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Medium Rifle Single Round B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Medium Rifle B RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 400

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Medium Rifle Single Round C"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Medium Rifle C RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 250

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Medium Rifle Single Round D"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInPrepareDelay = 350
ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInAfterDelay = 150

ScrappersData.ReloadSoundSets.Magazine[name].RoundInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInPrepareSound["SoundContainer"] = "Reload RoundLoad Medium Rifle D RoundInPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInPrepareSound["Length"] = 350

ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Medium Rifle D RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 150

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Large Rifle Single Round A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInPrepareDelay = 230
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Large Rifle A RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 450

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Large Rifle Single Round B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Large Rifle B RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 450

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Large Rifle Single Round C"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Large Rifle C RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

-- mind that this also includes roundstuff as a necessity
name = "Reload RoundLoad Medium Rifle Stripper A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnPrepareDelay = 400
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnAfterDelay = 180

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInPrepareDelay = 180
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInAfterDelay = 300

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffPrepareDelay = 300
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffAfterDelay = 400

ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInPrepareDelay = 180
ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInAfterDelay = 310

ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["SoundContainer"] = "Reload RoundLoad Medium Rifle A StripperOnPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["Length"] = 110

ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["SoundContainer"] = "Reload RoundLoad Medium Rifle A StripperOn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["Length"] = 140

ScrappersData.ReloadSoundSets.Magazine[name].StripperInPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInPrepareSound["SoundContainer"] = nil
ScrappersData.ReloadSoundSets.Magazine[name].StripperInPrepareSound["Length"] = 0

ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["SoundContainer"] = "Reload RoundLoad Medium Rifle A StripperIn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["Length"] = 215

ScrappersData.ReloadSoundSets.Magazine[name].StripperOffPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffPrepareSound["SoundContainer"] = nil
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffPrepareSound["Length"] = 0

ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["SoundContainer"] = "Reload RoundLoad Medium Rifle A StripperOff"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["Length"] = 150
...
ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"StripperOnPrepareSound", "StripperOnSound", "StripperInPrepareSound", "StripperInSound", "StripperOffPrepareSound", "StripperOffSound", "RoundInPrepareSound", "RoundInSound"}

-- mind that this also includes roundstuff as a necessity
name = "Reload RoundLoad Medium Rifle Stripper B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["SoundContainer"] = nil
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["Length"] = 0

ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["SoundContainer"] = "Reload RoundLoad Medium Rifle B StripperOn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["Length"] = 325
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["SoundContainer"] = "Reload RoundLoad Medium Rifle B StripperIn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["Length"] = 500
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["SoundContainer"] = "Reload RoundLoad Medium Rifle B StripperOff"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["Length"] = 500
...
-- mind that this also includes roundstuff as a necessity
name = "Reload RoundLoad Medium Rifle Stripper C"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnPrepareDelay = 400
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnAfterDelay = 145

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInPrepareDelay = 145
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInAfterDelay = 250

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffPrepareDelay = 270
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffAfterDelay = 500
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["SoundContainer"] = "Reload RoundLoad Medium Rifle C StripperOn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["Length"] = 200
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["SoundContainer"] = "Reload RoundLoad Medium Rifle C StripperIn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["Length"] = 375
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["SoundContainer"] = "Reload RoundLoad Medium Rifle C StripperOff"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["Length"] = 255
...
-- mind that this also includes roundstuff as a necessity
name = "Reload RoundLoad Large Rifle Stripper A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnPrepareDelay = 500
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnAfterDelay = 160

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInPrepareDelay = 160
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInAfterDelay = 300

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffPrepareDelay = 280
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffAfterDelay = 400
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["SoundContainer"] = "Reload RoundLoad Large Rifle A StripperOnPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["Length"] = 500

ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["SoundContainer"] = "Reload RoundLoad Large Rifle A StripperOn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["SoundContainer"] = "Reload RoundLoad Large Rifle A StripperIn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["Length"] = 410
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["SoundContainer"] = "Reload RoundLoad Large Rifle A StripperOff"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["Length"] = 340
...
-- mind that this also includes roundstuff as B necessity
name = "Reload RoundLoad Large Rifle Stripper B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffPrepareDelay = 320
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffAfterDelay = 400
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["SoundContainer"] = "Reload RoundLoad Large Rifle B StripperOn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["SoundContainer"] = "Reload RoundLoad Large Rifle B StripperIn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["Length"] = 410
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["SoundContainer"] = "Reload RoundLoad Large Rifle B StripperOff"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["Length"] = 340
...
-- mind that this also includes roundstuff as a necessity
name = "Reload RoundLoad Large Rifle Stripper C"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnPrepareDelay = 400
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnAfterDelay = 250

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInPrepareDelay = 250
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInAfterDelay = 310

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffPrepareDelay = 310
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffAfterDelay = 400
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["SoundContainer"] = "Reload RoundLoad Large Rifle C StripperOn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["Length"] = 325
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["SoundContainer"] = "Reload RoundLoad Large Rifle C StripperIn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["SoundContainer"] = "Reload RoundLoad Large Rifle C StripperOff"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["Length"] = 130
...
name = "Reload RoundLoad Very Large Rifle Single Round A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInPrepareDelay = 350
ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInAfterDelay = 400
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Very Large Rifle A RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 285

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Very Large Rifle Single Round B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInPrepareDelay = 500
ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInAfterDelay = 500
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Very Large Rifle B RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 400

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Medium Shotgun Single Round A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadPrepareSound["Length"] = 0

ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["SoundContainer"] = "Reload RoundLoad Medium Shotgun A BreechLoad"
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Medium Shotgun A RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 350

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"BreechLoadPrepareSound", "BreechLoadSound", "RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Medium Shotgun Single Round B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["SoundContainer"] = "Reload RoundLoad Medium Shotgun B BreechLoad"
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Medium Shotgun B RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 350

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"BreechLoadPrepareSound", "BreechLoadSound", "RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Large Shotgun Single Round A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["SoundContainer"] = "Reload RoundLoad Large Shotgun A BreechLoad"
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["Length"] = 270
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Large Shotgun A RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"BreechLoadPrepareSound", "BreechLoadSound", "RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Large Shotgun Single Round B"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["SoundContainer"] = "Reload RoundLoad Large Shotgun B BreechLoad"
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Large Shotgun B RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"BreechLoadPrepareSound", "BreechLoadSound", "RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Large Shotgun Single Round C"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["SoundContainer"] = "Reload RoundLoad Large Shotgun C BreechLoad"
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Large Shotgun C RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"BreechLoadPrepareSound", "BreechLoadSound", "RoundInPrepareSound", "RoundInSound"}

name = "Reload RoundLoad Large Shotgun Single Round D"
ScrappersData.ReloadSoundSets.Magazine[name] = {}
...
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["SoundContainer"] = "Reload RoundLoad Large Shotgun D BreechLoad"
ScrappersData.ReloadSoundSets.Magazine[name].BreechLoadSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["SoundContainer"] = "Reload RoundLoad Large Shotgun D RoundIn"
ScrappersData.ReloadSoundSets.Magazine[name].RoundInSound["Length"] = 300

ScrappersData.ReloadSoundSets.Magazine[name].SoundList = {"BreechLoadPrepareSound", "BreechLoadSound", "RoundInPrepareSound", "RoundInSound"}

-- mind that this also includes roundstuff as a necessity
name = "Reload RoundLoad Very Large Rifle Stripper A"
ScrappersData.ReloadSoundSets.Magazine[name] = {}

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnPrepareDelay = 600
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOnAfterDelay = 200

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInPrepareDelay = 600
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperInAfterDelay = 325

ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffPrepareDelay = 325
ScrappersData.ReloadSoundSets.Magazine[name].BaseStripperOffAfterDelay = 800

ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInPrepareDelay = 350
ScrappersData.ReloadSoundSets.Magazine[name].BaseRoundInAfterDelay = 400

ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["SoundContainer"] = "Reload RoundLoad Very Large Rifle A StripperOnPrepare"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnPrepareSound["Length"] = 250

ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["SoundContainer"] = "Reload RoundLoad Very Large Rifle A StripperOn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOnSound["Length"] = 240
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["SoundContainer"] = "Reload RoundLoad Very Large Rifle A StripperIn"
ScrappersData.ReloadSoundSets.Magazine[name].StripperInSound["Length"] = 500
...
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound = {}
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["SoundContainer"] = "Reload RoundLoad Very Large Rifle A StripperOff"
ScrappersData.ReloadSoundSets.Magazine[name].StripperOffSound["Length"] = 730
...
name = "Reload Bolt Very Small Rifle A"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Very Small Rifle A BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltLockSound["SoundContainer"] = "Reload Bolt Very Small Rifle A BoltLock"
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Very Small Rifle A BoltForward"
...
name = "Reload Bolt Very Small Rifle E"
ScrappersData.ReloadSoundSets.Bolt[name] = {}

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 100
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 225

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 225
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 600
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Very Small Rifle E BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 380
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Very Small Rifle E BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 500
...
name = "Reload Bolt Small Rifle B"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Small Rifle B BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 150
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Small Rifle B BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 130

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Small Rifle C"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Small Rifle C BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 150
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Small Rifle C BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 160

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}


name = "Reload Bolt Small Rifle D"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Small Rifle D BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 150
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Small Rifle D BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 160
...
name = "Reload Bolt Medium Rifle K"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Rifle K BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 190
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Rifle K BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 200

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Medium Rifle L"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Rifle L BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 190
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Rifle L BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250
...
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltUpAfterDelay = 55

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 55
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 125

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 125
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 100

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownPrepareDelay = 100
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownAfterDelay = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["SoundContainer"] = "Reload Bolt Medium Single Rifle A BoltUp"
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["Length"] = 75
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Single Rifle A BoltBack"
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Single Rifle A BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 210
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["SoundContainer"] = "Reload Bolt Medium Single Rifle A BoltDown"
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["Length"] = 75
...
name = "Reload Bolt Medium Single Rifle B"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["SoundContainer"] = "Reload Bolt Medium Single Rifle B BoltUp"
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["Length"] = 100
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Single Rifle B BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 250
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Single Rifle B BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["SoundContainer"] = "Reload Bolt Medium Single Rifle B BoltDown"
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["Length"] = 110

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltUpPrepareSound", "BoltUpSound", "BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound", "BoltDownPrepareSound", "BoltDownSound"}


name = "Reload Bolt Medium Single Rifle C"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 150
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Single Rifle C BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Single Rifle C BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 300

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Medium Single Rifle D"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound["SoundContainer"] = "Reload Bolt Medium Single Rifle D BoltBackPrepare"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound["Length"] = 100

ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Single Rifle D BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 150
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Single Rifle D BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 240

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Medium Shotgun A"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Shotgun A PumpBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Shotgun A PumpForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Medium Shotgun B"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Shotgun B PumpBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Shotgun B PumpForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Medium Shotgun C"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Medium Shotgun C PumpBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Medium Shotgun C PumpForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250
...
name = "Reload Bolt Large Rifle F"
ScrappersData.ReloadSoundSets.Bolt[name] = {}

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 450
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 150

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltLockPrepareDelay = 150
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltLockAfterDelay = 400

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 300
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 500
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Rifle F BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 230
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltLockSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltLockSound["SoundContainer"] = "Reload Bolt Large Rifle F BoltLock"
ScrappersData.ReloadSoundSets.Bolt[name].BoltLockSound["Length"] = 150
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Rifle F BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 300

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltLockPrepareSound", "BoltLockSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Rifle G"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Rifle G BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 330
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Rifle G BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 370

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Rifle H"
ScrappersData.ReloadSoundSets.Bolt[name] = {}

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 100
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 300
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Rifle H BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 500
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Rifle H BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 370

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Rifle I"
ScrappersData.ReloadSoundSets.Bolt[name] = {}

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 100
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 300

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 350
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 400
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Rifle I BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 300
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Rifle I BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 225

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Rifle J"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound["SoundContainer"] = "Reload Bolt Large Rifle J BoltBackPrepare"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound["Length"] = 200

ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Rifle J BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 210
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Rifle J BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 280

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Rifle K"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Rifle K BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 210
...
name = "Reload Bolt Large Rifle M"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Rifle M BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Rifle M BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 175

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Shotgun A"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Shotgun A PumpBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Shotgun A PumpForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 200

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Shotgun B"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Shotgun B PumpBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Shotgun B PumpForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 200

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Shotgun C"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound["SoundContainer"] = "Reload Bolt Large Shotgun C PumpBackPrepare"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackPrepareSound["Length"] = 100

ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Shotgun C PumpBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 200
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Shotgun C PumpForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 200

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Single Rifle A"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownPrepareDelay = 150
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["SoundContainer"] = "Reload Bolt Large Single Rifle A BoltUp"
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Single Rifle A BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 360
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Single Rifle A BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["SoundContainer"] = "Reload Bolt Large Single Rifle A BoltDown"
...
name = "Reload Bolt Large Single Rifle D"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Single Rifle D LeverOpen"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 220
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Single Rifle D LeverClose"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Large Single Rifle E"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 75
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 110

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 115
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 150

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownPrepareDelay = 100
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownAfterDelay = 250
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["SoundContainer"] = "Reload Bolt Large Single Rifle E BoltUp"
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["Length"] = 140
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Large Single Rifle E BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 360
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Large Single Rifle E BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["SoundContainer"] = "Reload Bolt Large Single Rifle E BoltDown"
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["Length"] = 250

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltUpPrepareSound", "BoltUpSound", "BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound", "BoltDownPrepareSound", "BoltDownSound"}

name = "Reload Bolt Very Large Rifle A"
ScrappersData.ReloadSoundSets.Bolt[name] = {}

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 100
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 250

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 270
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 450
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Very Large Rifle A BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 410
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Very Large Rifle A BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 370

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound"}

name = "Reload Bolt Very Large Rifle B"
ScrappersData.ReloadSoundSets.Bolt[name] = {}
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Very Large Rifle B BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 410
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Very Large Rifle B BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 370
...
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltUpPrepareDelay = 50
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltUpAfterDelay = 100

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 105
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 250

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 250
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 125

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownPrepareDelay = 125
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownAfterDelay = 550
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle A BoltUp"
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["Length"] = 130
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle A BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 450
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle A BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 250
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle A BoltDown"
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["Length"] = 500

ScrappersData.ReloadSoundSets.Bolt[name].SoundList = {"BoltUpPrepareSound", "BoltUpSound", "BoltBackPrepareSound", "BoltBackSound", "BoltForwardPrepareSound", "BoltForwardSound", "BoltDownPrepareSound", "BoltDownSound"}

name = "Reload Bolt Very Large Single Rifle B"
ScrappersData.ReloadSoundSets.Bolt[name] = {}

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltUpPrepareDelay = 160
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltUpAfterDelay = 150

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackPrepareDelay = 150
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltBackAfterDelay = 450

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardPrepareDelay = 450
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltForwardAfterDelay = 230

ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownPrepareDelay = 230
ScrappersData.ReloadSoundSets.Bolt[name].BaseBoltDownAfterDelay = 650

ScrappersData.ReloadSoundSets.Bolt[name].BoltUpPrepareSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpPrepareSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle B BoltUpPrepare"
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpPrepareSound["Length"] = 160

ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle B BoltUp"
ScrappersData.ReloadSoundSets.Bolt[name].BoltUpSound["Length"] = 160
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle B BoltBack"
ScrappersData.ReloadSoundSets.Bolt[name].BoltBackSound["Length"] = 335

ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardPrepareSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardPrepareSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle B BoltForwardPrepare"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardPrepareSound["Length"] = 210

ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle B BoltForward"
ScrappersData.ReloadSoundSets.Bolt[name].BoltForwardSound["Length"] = 350
...
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound = {}
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["SoundContainer"] = "Reload Bolt Very Large Single Rifle B BoltDown"
ScrappersData.ReloadSoundSets.Bolt[name].BoltDownSound["Length"] = 260
